<div class="flex flex-col gap-3 border py-5 px-3 rounded-2xl">
    <h1 class="font-bold text-lg">What is Lorem Ipsum?</h1>
    ...
    <p class="text-sm">The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as
        opposed to using
    ...
    <a class="bg-primary text-white text-center rounded-lg py-1.5 mt-2 text-sm" href="/post">Continue reading</a>
</div>
